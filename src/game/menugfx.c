...
#ifndef PLATFORM_N64
	// Blur framebuffer not supported on GX2 - render black background
	return menugfxRenderGradient(gdl, 0, 0, viGetWidth(), viGetHeight(), 0x000000ff, 0x000000ff, 0x000000ff);
#endif
